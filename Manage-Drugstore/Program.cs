                    ...
                    if (selectedNumber >= 0 && selectedNumber <= 4)
                    {
                        switch (selectedNumber)
                        {
                            ...
                            case 4:
                                ...
                                while (true)
                                {
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "5 - Create Owner");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "6 - Update Owner");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "7 - Delete Owner");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "8 - Get All Owners");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "9 - Create Drugstore");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "10 - Update Drugstore");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "11- Delete Drugstore");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "12- Get All Drugstores ");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "13- Get All Drugstores By Owner");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "14 - Sale");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "15 - Create Druggist");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "16- Update Druggist");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "17- Delete Druggist");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "18- Get All Drugstores ");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "19 - Get All Druggist by Drugstore");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "20- Create Drug");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "21- Update Drug");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "22- Delete Drug");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "23- Get All Drugs");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "24- Get All Drugs by Drugstore");
                                    ConsoleHelpers.WriteTextWithColor(ConsoleColor.Green, "25 - Filter");
